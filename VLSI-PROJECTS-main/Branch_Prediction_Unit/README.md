...
<p align="center">
  <img src="screenshots/final_layout_innovus.png" alt="Final routed layout in Innovus" width="600">
</p>
...
<p align="center">
  <img src="screenshots/genus_schematic.png" alt="Synthesized gate-level schematic" width="700">
</p>
...
<p align="center">
  <img src="screenshots/waveform_sim_1.png" alt="Simulation waveform - early cycles" width="700"><br>
  <em>Early simulation cycles — clk, prediction_out, flush_out, total_branches tracked in SimVision.</em>
</p>

<p align="center">
  <img src="screenshots/waveform_sim_final.png" alt="Simulation waveform - final result" width="700"><br>
...
<p align="center">
  <img src="screenshots/waveform_sim_2.png" alt="Simulation waveform - mid cycles" width="700"><br>
  <img src="screenshots/waveform_sim_3.png" alt="Simulation waveform - later cycles" width="700">
</p>
</details>
...
Full reports: [`area_report.txt`](./reports/area_report.txt) · [`power_report.txt`](./reports/power_report.txt) · [`timing_report.txt`](./reports/timing_report.txt)
...
During synthesis, two RTL constructs required correction for tool compatibility (see inline comments in [`rtl/Advanced_MultiCycle_Top.v`](./rtl/Advanced_MultiCycle_Top.v)):
...
Full writeup of challenges and resolutions: [`docs/project_report.pdf`](./docs/project_report.pdf)
...
- 📄 [Full Project Report](./docs/project_report.pdf) — technologies used, achievements, challenges faced, and future improvements
- 📄 [Flow Guide](./docs/flow_guide.pdf) — step-by-step RTL-to-GDSII flow reference (Cadence Genus + Innovus)
